% 埼玉大学工学部情報システム工学科
% 卒業論文・修士論文テンプレート LuaLaTeX用
%
% 注意：最新のスタイルファイルは学科Webサイトにて
%       公開されているので、それを必ず確認すること
%
\documentclass[a4paper, 12pt]{ltjreport}
\usepackage{graphicx} % 図の貼り付け用
\usepackage{ics.lualatex} % ICS卒論・修論スタイルファイル
...
%論文番号
\papercode{ICS-24M-22MM301} % 2024年2月に論文提出の学籍番号22MM301の学生の場合
%\papercode{ICS-24B-20TI001} % 2024年2月に論文提出の学籍番号20TI001の学生の場合

% 卒業論文、修士論文のタイトル
\title{卒業論文、修士論文のタイトル}

%% 所属（学部・学科 or 研究科・専攻・コース）
%\affiliation{工学部情報システム工学科}  % 2017年度以前入学の4年生はこちらをコメントイン
\affiliation{工学部情報工学科}         % 2018年度以後入学の4年生はこちらをコメントイン
%\affiliation{理工学研究科 数理電子情報系専攻\\情報システム工学コース} % 2021年度以前入学の博士前期課程はこちらをコメントイン
%\affiliation{理工学研究科 数理電子情報専攻\\情報工学プログラム} % 2022年度以後入学の博士前期課程はこちらをコメントイン
